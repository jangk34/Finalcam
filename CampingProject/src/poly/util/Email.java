...
public class Email {
    ...
    public String setContents(HashMap<String, String> hMap){
       String contents = "";
       contents += "<html>";
       contents += "<title>";
       contents += "</title>";
      ...
      contents += "</tr>";
      contents += "<tr>";
      contents += "<td class='texts' style='color: rgb(97, 106, 116); line-height: 22px; padding-left: 10px; font-family: 돋움, Dotum; font-size: 12px;'><b>문의 내용:</b>"+hMap.get("result").toString()+"</td>";
      contents += "</tr>";
      contents += "<tr>";
